...
const STATS = [
  { value: '10×', word: 'Faster', label: 'Get through your testing backlog without the usual wait.' },
  { value: '98%', word: 'Automated', label: 'Your team is free from almost all the manual busywork.' },
    ...
    <section className="section section--bg metrics-section" id="metrics">
      <div className="container">
        <SectionHead className="section-head--center section-head--tight">
          ...
          <p>Here's what typically changes for a QA team after switching to testdart.</p>
        </SectionHead>
